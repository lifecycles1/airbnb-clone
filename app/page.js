...
export default async function Home() {
  const exploreData = await fetch("https://airbnb-clone-lifecycles1.vercel.app/api/smallcards").then((res) => res.json());
  const cardsData = await fetch("https://airbnb-clone-lifecycles1.vercel.app/api/cards").then((res) => res.json());
  return (
    <div>
      <Header />
      <Banner />
